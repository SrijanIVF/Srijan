      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-pink-50">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="mt-14 text-center">
            <p className="text-pink-600 font-semibold text-lg sm:text-xl">
              Start your fertility journey with expert guidance ❤️
            </p>

            <button
              onClick={() => setShowPopup(true)}
              className="mt-6 px-6 sm:px-8 py-3 bg-pink-600 text-white rounded-full font-semibold hover:bg-pink-700 transition-all duration-300 shadow-md hover:shadow-lg"
            >
              Request Call Back
            </button>
          </div>
